...
Identity: same pet in every frame: A compact friendly desk-sprite companion for a pragmatic software engineer: graphite charcoal body, teal accent panels, small tool satchel, alert eyes, calm focused expression, clean modern non-logo design, no text.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
